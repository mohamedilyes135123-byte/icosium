...
INSERT INTO auth.identities (
    ...
    (gen_random_uuid(), '11111111-1111-1111-1111-111111111111',
     format('{"sub":"%s","email":"%s"}', '11111111-1111-1111-1111-111111111111', 'patient@3inaya.com')::jsonb,
     'email', 'patient@3inaya.com', NOW(), NOW(), NOW()),
    (gen_random_uuid(), '22222222-2222-2222-2222-222222222222',
     format('{"sub":"%s","email":"%s"}', '22222222-2222-2222-2222-222222222222', 'doctor@3inaya.com')::jsonb,
     'email', 'doctor@3inaya.com', NOW(), NOW(), NOW()),
    (gen_random_uuid(), '33333333-3333-3333-3333-333333333333',
     format('{"sub":"%s","email":"%s"}', '33333333-3333-3333-3333-333333333333', 'lab@3inaya.com')::jsonb,
     'email', 'lab@3inaya.com', NOW(), NOW(), NOW()),
    (gen_random_uuid(), '44444444-4444-4444-4444-444444444444',
     format('{"sub":"%s","email":"%s"}', '44444444-4444-4444-4444-444444444444', 'pharmacy@3inaya.com')::jsonb,
     'email', 'pharmacy@3inaya.com', NOW(), NOW(), NOW()),
    (gen_random_uuid(), '55555555-5555-5555-5555-555555555555',
     format('{"sub":"%s","email":"%s"}', '55555555-5555-5555-5555-555555555555', 'admin@3inaya.com')::jsonb,
     'email', 'admin@3inaya.com', NOW(), NOW(), NOW())
