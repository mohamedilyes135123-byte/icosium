      ...
      <div className="w-full max-w-md bg-white/80 backdrop-blur-xl rounded-[2.5rem] p-8 shadow-2xl border border-white relative z-10">
        <div className="flex flex-col items-center mb-8">
          <div className="relative mb-4">
            <div className="w-28 h-28 rounded-3xl bg-white/90 border border-purple-100 shadow-xl shadow-purple-500/10 flex items-center justify-center relative z-10 logo-float backdrop-blur-sm">
              <img src="/logo.png" alt="عناية" className="w-20 h-20 object-contain drop-shadow-md" />
            </div>
            <div className="absolute inset-[-12px] z-0 glow-pulse rounded-full blur-2xl bg-gradient-to-tr from-purple-400 via-pink-400 to-fuchsia-300" />
          </div>
