      ...
      <div className="w-full max-w-md bg-white/80 backdrop-blur-xl rounded-[2.5rem] p-8 shadow-2xl border border-white relative z-10">
        <div className="flex flex-col items-center mb-8">
          <div className="relative mb-4">
            <div className="absolute inset-[-8px] z-0 glow-pulse rounded-3xl blur-xl bg-gradient-to-tr from-indigo-400 via-blue-400 to-cyan-300 opacity-60" />
            <div className="w-28 h-28 rounded-2xl bg-white border border-indigo-100 shadow-xl flex items-center justify-center relative z-10 logo-float">
