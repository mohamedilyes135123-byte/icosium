    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md bg-white/80 backdrop-blur-xl rounded-[2.5rem] p-8 shadow-2xl border border-white relative z-10">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-black text-slate-800">Ù…Ø±ÙƒØ² Ø¥Ø¯Ø§Ø±Ø© Ø§Ù„Ù†Ø¸Ø§Ù…</h1>
          <p className="text-slate-500 text-sm mt-1">Ø§Ù„ÙˆÙ„ÙˆØ¬ Ù…Ù‚ØªØµØ± Ø¹Ù„Ù‰ Ù…Ø³Ø¤ÙˆÙ„ÙŠ Ø§Ù„Ø¯Ø¹Ù… ÙÙ‚Ø·</p>
        </div>
