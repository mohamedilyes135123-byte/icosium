    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md bg-white/80 backdrop-blur-xl rounded-[2.5rem] p-8 shadow-2xl border border-white relative z-10">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-black text-slate-800">{isLogin ? "╪¿┘ê╪º╪¿╪⌐ ╪º┘ä╪╡┘è╪»┘ä┘è╪º╪¬" : "╪╖┘ä╪¿ ╪º┘å╪╢┘à╪º┘à ╪╡┘è╪»┘ä┘è╪⌐"}</h1>
          <p className="text-slate-500 text-sm mt-1">┘å╪╕╪º┘à ╪╡╪▒┘ü ╪º┘ä┘ê╪╡┘ü╪º╪¬ ╪º┘ä┘à╪│╪¬┘é┘ä</p>
        </div>
