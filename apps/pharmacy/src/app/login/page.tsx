      ...
      <div className="w-full max-w-md bg-white/80 backdrop-blur-xl rounded-[2.5rem] p-8 shadow-2xl border border-white relative z-10">
        <div className="flex flex-col items-center mb-8">
          <div className="relative mb-4">
            <div className="w-28 h-28 rounded-3xl bg-white/90 border border-amber-100 shadow-xl shadow-amber-500/10 flex items-center justify-center relative z-10 logo-float backdrop-blur-sm">
              <img src="/logo.png" alt="عناية" className="w-20 h-20 object-contain drop-shadow-md" />
            </div>
            <div className="absolute inset-[-12px] z-0 glow-pulse rounded-full blur-2xl bg-gradient-to-tr from-orange-400 via-amber-400 to-yellow-300" />
          </div>
